...
import com.number26.bitcointest.BuildConfig;
...
public final class Logcat
{
	...
	{
		if(BuildConfig.LOGS) Log.d(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void e(String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.e(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void e(Throwable tr, String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.e(TAG, getCodeLocation().toString() + formatMessage(msg, args), tr);
	}


	public static void i(String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.i(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void v(String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.v(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void w(String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.w(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}


	public static void wtf(String msg, Object... args)
	{
		if(BuildConfig.LOGS) Log.wtf(TAG, getCodeLocation().toString() + formatMessage(msg, args));
	}
